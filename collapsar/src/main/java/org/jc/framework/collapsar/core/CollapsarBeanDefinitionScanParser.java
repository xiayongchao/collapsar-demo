 ...
 * @date 2019/3/25
 */
public abstract class CollapsarBeanDefinitionScanParser<T> implements ResourceLoaderAware, EnvironmentAware {
    private Environment environment;
    private MetadataReaderFactory metadataReaderFactory;
    private ResourcePatternResolver resourcePatternResolver;
    private Class<? extends Annotation> beanAnnotationClass;

    public CollapsarBeanDefinitionScanParser(Class<? extends Annotation> beanAnnotationClass) {
