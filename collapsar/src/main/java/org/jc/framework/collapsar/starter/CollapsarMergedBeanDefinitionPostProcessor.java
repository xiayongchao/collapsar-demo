...
public class CollapsarMergedBeanDefinitionPostProcessor implements MergedBeanDefinitionPostProcessor, BeanFactoryAware, ApplicationListener<ContextRefreshedEvent> {
    ...
    public void postProcessMergedBeanDefinition(RootBeanDefinition beanDefinition, Class<?> beanType, String beanName) {
        ...
        if (collapsarComponentScan != null
                && ArrayUtils.isNotEmpty(collapsarComponentScan.scope())) {
            for (CollapsarComponentScan.Rule rule : collapsarComponentScan.scope()) {
                if (rule == null || ArrayUtils.isEmpty(rule.basePackages())) {
                    continue;
                }
                collapsarComponentScanDefinitions.add(new CollapsarComponentScanDefinition(rule));
            }
        }
